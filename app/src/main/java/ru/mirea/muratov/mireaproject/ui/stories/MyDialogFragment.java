    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Добавить заметку в истории?")
                ...
                .setPositiveButton("Сохранить", (dialog, id) -> {
                    ...
                    ru.mirea.muratov.mireaproject.ui.stories.AppDatabase db = App.getInstance().getDatabase();
                    HistoryDao historyDao = db.storyDao();
                    ru.mirea.muratov.mireaproject.ui.stories.Cell cell = new ru.mirea.muratov.mireaproject.ui.stories.Cell();
                ...
                .setNeutralButton("Очистить истории",
                        (dialog, id) -> {
                            ...
                            ru.mirea.muratov.mireaproject.ui.stories.AppDatabase db = App.getInstance().getDatabase();
                            HistoryDao historyDao = db.storyDao();
                            List<ru.mirea.muratov.mireaproject.ui.stories.Cell> cells = historyDao.getAll();
                            for (ru.mirea.muratov.mireaproject.ui.stories.Cell cell : cells){
