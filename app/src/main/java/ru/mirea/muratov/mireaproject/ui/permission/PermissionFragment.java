package ru.mirea.muratov.mireaproject.ui.permission;
...
public class PermissionFragment extends Fragment implements SensorEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView = root.findViewById(R.id.imagePhoto);
        buttonPhoto = root.findViewById(R.id.button_photo);
        buttonPlay = root.findViewById(R.id.button_play_record);
        buttonStart = root.findViewById(R.id.button_start_record);
        buttonStop = root.findViewById(R.id.button_stop_record);
        buttonUnplay = root.findViewById(R.id.button_unplay_record);
