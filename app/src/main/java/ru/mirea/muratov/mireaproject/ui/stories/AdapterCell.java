...
public class AdapterCell extends RecyclerView.Adapter<ru.mirea.muratov.mireaproject.ui.stories.AdapterCell.StoryHolder>{
    List<ru.mirea.muratov.mireaproject.ui.stories.Cell> stories;

    public AdapterCell(List<ru.mirea.muratov.mireaproject.ui.stories.Cell> stories){
    ...
    class StoryHolder extends RecyclerView.ViewHolder{
        ...
        void bind(int listIndex){
            ru.mirea.muratov.mireaproject.ui.stories.Cell cell = stories.get(listIndex);
